...
function MaterielDetail() {
  return (
    <div>
        ...
        <div className='text-center mt-20 2xl: text-neutral-800 text-5xl lg:text-6xl font-signikaSemiBold'>Notre matériel</div>
        <div className='container grid 2xl:grid-rows-2 w-full '>
            <div>
