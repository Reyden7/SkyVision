    ...
    <div className='p-7 mt-20 2xl:mt-10 '>
      ...
      <div className=" grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-3  md:ml-40 2xl:ml-0   2xl:mr-96 ">
        <div  className=' w-auto md:w-60  2xl:w-72 lg:w-60 md:-ml-14 2xl:ml-44 3xl:ml-96    mx-auto'>
          <img data-aos-duration="1000"  data-aos="flip-up" className='mt-0 2xl:mt-0 shadow-lg shadow-black' src={img1}  alt="Image 1" />
          <img  data-aos-duration="2000" data-aos="flip-up" className='mt-4 2xl:mt-8 shadow-lg shadow-black' src={img2} alt="Image 2" />
          <img data-aos-duration="3000"  data-aos="flip-up" className='mt-4 2xl:mt-8 shadow-lg shadow-black' src={img3} alt="Image 3" />
        </div>
        <div className='w-auto 2xl:ml-0 md:w-60 2xl:w-80 lg:w-60 ml-4 lg:-ml-16 xl:-ml-52 3xl:ml-0    mx-auto 2xl:mt-40 3xl:-ml-52 mt-20'>
          <img data-aos-duration="2500"  data-aos="flip-up" className='shadow-lg shadow-black' src={img4} alt="Image 4" />
          <img data-aos-duration="1700"  data-aos="flip-up" className='2xl:mt-8 mt-4 shadow-lg shadow-black' src={img5} alt="Image 5" />
        </div>
        <div data-aos-duration="2000" data-aos="fade-left" className='mt-56 mx-auto 2xl:block lg:block xl:-ml-56 2xl:ml-0 hidden  '>
