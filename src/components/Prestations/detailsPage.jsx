  ...
  const elements = [
    {
      ...
      Prix: 100,
      Description: "Confiez nous la réalisation d'images ou video aériennes de qualité professionnelle pour vos projets. Ce format vous propose des vidéos brutes, sans artifices ni effets spéciaux, offrant ainsi une flexibilité totale pour personnaliser la post-production selon votre vision créative."
    },
    {
      id: '2',
      titre: "Réalisation avancée",
      Prix: 400,
      Description: "Nos compétences de pilotes FPV professionnels sont à votre disposition pour des prises de vue aériennes avancée. Nous excellons dans la réalisation de figures impressionnantes et la capture de scènes dynamiques pour vos projets. Cette offre vous propose des images brutes de haute qualité, vous laissant la liberté de personnaliser la post-production selon vos besoins créatifs."
    },
    {
      id: '3',
...
const element = elements.find((elem) => elem.id === id);
  ...
  return (
    <div>
        <Navbar/>
        <div className='absolute transform -scale-x-50 scale-y-50 2xl:-scale-x-50 2xl:scale-y-50  2xl:w-2xl w-xl left-0 2xl:-mt-20 2xl:-ml-72 -ml-36 -mt-16  '><img className='image-container 2xl:w-full w-96' src={img1}/></div>
        <div className='container font-signikaLight pl-10 pr-10 2xl:w-1/2  md:pl-10 md:pr-10  2xl:mt-32 2xl:ml-96 transform 2xl:translate-x-12 text-justify h-auto  '>
            <div className='font-signikaRegular text-neutral-800  p-5 text-2xl  text-center 2xl:text-3xl '>{element ? element.titre : 'Élément non trouvé'}</div>
