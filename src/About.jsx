  ...
  return (
    <div>
      ...
      <div className="container mx-auto flex flex-col 2xl:w-1/2 w-5/6  2xl:h-auto  px-10 pt-10 pb-20 mt-10 bg-neutral-800 bg-opacity-80 center rounded-3xl border-4 border-neutral-500 2xl:mb-20 mb-40  ">
        ...
        <div data-aos="fade-up" className="text-neutral-200 2xl:text-2xl text-justify text-center mb-5 text-md lg:text-3xl font-signikaRegular 2xl:mt-5">Fondée récemment avec une passion commune pour la captation aérienne, SkyVision est une entreprise dynamique basée à Chevigny-Saint-Sauveur, en Côte-d'Or (21). </div>
        ...
        <div data-aos="fade-up" className="text-neutral-200 2xl:text-2xl text-justify text-center mb-5 text-md lg:text-3xl font-signikaRegular 2xl:mt-5">Nous sommes fiers d'être implantés au cœur de la Bourgogne, nous sommes impatients de promouvoir la beauté de notre région</div>
        ...
        <div data-aos="fade-up" className="text-neutral-200 2xl:text-2xl text-justify text-center mb-5 text-md lg:text-3xl font-signikaRegular 2xl:mt-5">Bien que nouvellement implanté, nos investissements dans les dernières technologies garantissent des prises de vue de haute qualité et des résultats visuels exceptionnels.</div>
        ...
        <div data-aos="fade-up" className="text-neutral-200 2xl:text-2xl text-justify text-center mb-5 text-md lg:text-3xl font-signikaRegular 2xl:mt-5">Si vous êtes prêt à embarquer pour une aventure visuelle avec SkyVision, n'hésitez pas à nous contacter.</div>
