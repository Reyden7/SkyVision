...
export default function Services (){
  ...
  <div>
    ...
    <div className="container 2xl:-mt-56 w-96 3xl:mt-96  ml-5 space-x-5 2xl:w-full 3xl:w-full 2xl:h-screen 3xl:h-auto   md:w-full md:mx-auto md:p-2  flex 2xl:space-x-96 md:space-x-20   justify-center transform 2xl:scale-50 3xl:scale-100 3xl:space-x-40 ">
      <div className="md:w-2/5 2xl:w-2/5 3xl:4/5  h-full w-full  2xl:pl-20 2xl:pr-20 pl-5 pr-5 3xl:py-24  bg-neutral-800 rounded-3xl bgAnim-container shadow-2xl shadow-black  "> 
      ...
      <div className="md:w-2/5 2xl:mb-36 mb-20 2xl:w-2/5   w-full pl-5 pr-5 2xl:mt-20 2xl:pl-20 2xl:pr-20   bg-neutral-800 rounded-3xl bgAnim-container shadow-2xl shadow-black ">
